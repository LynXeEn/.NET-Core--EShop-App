...
namespace ConcertApp.Web.Controllers
{
    public class ConcertTicketsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.ConcertTickets.Include(c => c.TicketForConcert);
        ...
        {
            ViewData["ConcertId"] = new SelectList(_context.Concerts, "Id", "ConcertDate");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,NumberOfPeople,ConcertId")] ConcertTicket concertTicket)
        {
            ...
            ViewData["ConcertId"] = new SelectList(_context.Concerts, "Id", "ConcertDate", concertTicket.ConcertId);
            return View(concertTicket);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,NumberOfPeople,ConcertId")] ConcertTicket concertTicket)
        {
