...
namespace ConcertApp.Web.Controllers
{
    public class ConcertsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ConcertName,ConcertDate,ConcertImage,ConcertPrice,ConcertPlace")] Concert concert)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,ConcertName,ConcertDate,ConcertImage,ConcertPrice,ConcertPlace")] Concert concert)
        {
            if (id != concert.Id)
            {
                return NotFound();
